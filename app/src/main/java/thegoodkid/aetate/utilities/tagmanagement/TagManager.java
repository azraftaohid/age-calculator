package thegoodkid.aetate.utilities.tagmanagement;
...
import static thegoodkid.aetate.utilities.Reporter.reportVerbose;
...
public class TagManager {
    ...
    private static final String PREF_KEY = "thegoodkid.aetate.pref.TAGMANAGER";
    private static final String TAGS_KEY = "thegoodkid.aetate.pref.TAGMANAGER.TAGS";
    ...
    public List<Tag> prepareProfileForRemove(int profileId) {
        reportVerbose(LOG_TAG, "Preparing profile for removing (profile id: " + profileId + ")");
