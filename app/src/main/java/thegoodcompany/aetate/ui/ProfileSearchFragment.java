...
import thegoodcompany.aetate.databinding.FragmentProfileSearchBinding;
...
public class ProfileSearchFragment extends Fragment implements ProfileManagerInterface.OnProfileUpdatedListener,
    ...
    void setQueryText(@NonNull String s) {
        query = s;
        updateResult();
    }
